...
TRUNCATE `pizzability`.`order_item`;
TRUNCATE `pizzability`.`pizza_order`;
TRUNCATE `pizzability`.`customer`;
TRUNCATE `pizzability`.`pizza`;
SET FOREIGN_KEY_CHECKS = 1;

-- INSERT CUSTOMERS
INSERT INTO `pizzability`.`customer` (`id_customer`, `name`, `address`, `email`, `phone_number`)
VALUES ('863264988', 'Drake Theory', 'P.O. Box 136, 4534 Lacinia St.', 'draketheory@hotmail.com', '(826) 607-2278'),
       ...
       ('782668115', 'Charlotte Riddle', 'Ap #696-6846 Ullamcorper Avenue', 'amityrogers@outlook.com',
        '(744) 344-7768'),
...
-- INSERT PIZZAS
INSERT INTO `pizzability`.`pizza` (`id_pizza`, `name`, `description`, `price`, `vegetarian`, `vegan`, `available`)
VALUES (1, 'Pepperoni', 'Pepperoni, Homemade Tomato Sauce & Mozzarella.', 23.0, 0, 0, 1),
       ...
       (6, 'Goat Chesse', 'Portobello Mushrooms, Mozzarella, Parmesan & Goat Cheeses with Alfredo Sauce.', 24.0, 0, 0,
        1),
       (7, 'Mother Earth',
       ...
       (9, 'Marinated BBQ Chicken',
        'Marinated Chicken with Cilantro, Red Onions, Gouda, Parmesan & Mozzarella Cheeses.', 20.95, 0, 0, 0),
       (10, 'Truffle Cashew Cream', 'Wild mushrooms, Baby Kale, Shiitake Bacon & Lemon Vinaigrette. Soy free.', 22.0, 1,
        1, 1),
       (11, 'Rico Mor', 'Beef Chorizo, Sundried Tomatoes, Salsa Verde, Pepper, Jalapeno & pistachios', 23.0, 0, 0, 1),
       (12, 'Spinach Artichoke',
        'Fresh Spinach, Marinated Artichoke Hearts, Garlic, Fior de Latte, Mozzarella & Parmesan.', 18.95, 1, 0, 1);

-- INSERT ORDERS
INSERT INTO `pizzability`.`pizza_order` (`id_order`, `id_customer`, `date`, `price`, `method`, `additional_notes`)
VALUES (1, '192758012', DATE_SUB(NOW(), INTERVAL 5 DAY), 42.95, 'D', 'Don\'t be late pls.'),
...
-- INSERT ORDER ITEMS
INSERT INTO `pizzability`.`order_item` (`id_order`, `id_item`, `id_pizza`, `quantity`, `price`)
VALUES (1, 1, 1, 1, 23.0),
       (1, 2, 4, 1, 19.95),
       (2, 1, 2, 1, 18.5),
       (2, 2, 6, 1, 24.0),
